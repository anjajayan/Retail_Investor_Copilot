# Retail-Investor-Copilot
A production grade RAG application that is built on top of a corpus made of Regulatory and policy documents like SEC and FINRA.

Key details:
Target user: retail investor
